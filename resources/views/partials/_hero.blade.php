<section
	class="bg-laravel align-center relative mb-4 flex h-72 flex-col justify-center space-y-4 text-center">
	<div
		class="absolute top-0 left-0 h-full w-full bg-center bg-no-repeat opacity-10"
